...
DATABASES = {
    'default': {
        ...
        'NAME': 'fieldlogs',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = 't3ou2=lql-f*wjjgq^n@9#(m7_m#&amp;luqm$a2$$1iael8d!3lf^'
...
ROOT_URLCONF = 'fieldlogs.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'fieldlogs.wsgi.application'
...
DEFAULT_PHOTO_URI = '%s/images/default_photo.png' % STATIC_URL
DEFAULT_SIG_URI = '%s/images/default_sig.png' % STATIC_URL
